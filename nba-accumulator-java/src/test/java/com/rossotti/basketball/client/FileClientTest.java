...
public class FileClientTest {
	...
	public void retrieveBoxScore_200() throws IOException {
		...
		GameDTO game = fileClientBean.retrieveBoxScore(event);
	...
	public void retrieveRoster_200() throws IOException {
		...
		RosterDTO roster = fileClientBean.retrieveRoster(event);
	...
	public void retrieveStandings_200() throws IOException {
		...
		StandingsDTO standings = fileClientBean.retrieveStandings(event);
